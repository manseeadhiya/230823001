...
export default function Resume() {
  return (
    <div>
        ...
        <p> 
            <FaPhoneAlt />&nbsp; 600-00-000&nbsp;&nbsp;&nbsp;
            <MdAlternateEmail />&nbsp;  v-ford@gmail.com&nbsp;&nbsp;&nbsp;
            <RiLink />&nbsp; www.linkedin.com/vanessa-ford&nbsp;&nbsp;&nbsp;
            <FaLocationDot />&nbsp; San Francisco,CA</p>
            </header>
        ...
        <p style={{"display":"flex","gap":"15px"}}>
            <p style={{"borderBottom":"5px solid black","width":"","display":"inline"}}>Scrum</p>      
            <p style={{"borderBottom":"5px solid black","width":"","display":"inline"}}>Product Development</p>
            <p style={{"borderBottom":"5px solid black","width":"","display":"inline"}}>SQL</p>
            </p>
            <p style={{"display":"flex","gap":"15px","marginTop": "-30px"}}>
            <p style={{"borderBottom":"5px solid black","width":"","display":"inline"}}>Tableau</p>
            <p style={{"borderBottom":"5px solid black","width":"","display":"inline"}}>JIRA</p>
            <p style={{"borderBottom":"5px solid black","width":"","display":"inline"}}>Python</p>
        </p>
        </div>
        </div>
